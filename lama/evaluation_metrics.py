...
def get_ranking(log_probs, masked_indices, vocab, label_index = None, index_list = None, topk = 1000,
                P_AT = 10, print_generation=True, knn_pred=-1, modified=False):
    ...
    if label_index is not None:
        ...
        if knn_pred < 0:
            ...
            P_AT_1 = int(label_index == knn_pred)
            # if P_AT_1:
            #     pdb.set_trace()
    ...
    experiment_result["modified"] = modified
    #
